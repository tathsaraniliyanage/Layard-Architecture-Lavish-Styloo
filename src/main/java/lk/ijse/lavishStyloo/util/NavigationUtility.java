...
public class NavigationUtility {
    ...
    public static void onTheTopNavigation(Pane pane, String link) {
        try {
            FXMLLoader loader = new FXMLLoader(NavigationUtility.class.getResource("/view/" + link));
    ...
    public static void switchNavigation(String link, ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(NavigationUtility.class.getResource("/view/" + link));
    ...
    public static void popupNavigation(String link) {
        try {
            URL resource = NavigationUtility.class.getResource("/view/" + link);
